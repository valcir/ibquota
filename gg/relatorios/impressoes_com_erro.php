...
if ($num_stmt = $mysqli->prepare("SELECT count(*) 
        FROM impressoes WHERE cod_status_impressao != 1")) {
    $num_stmt->execute();
...
<center><h2><font color=#428bca>Impress&otilde;es com erro</font></h2><br>
...
<?php
   ...
   if ($sem_grupo == 1) {
      echo "<tr><td colspan=\"7\"><i>Sem registro de Impress&atilde;o</i></td></tr>";
   } else {
